...
(ert-deftest armstrong-number-digits ()
  "Single digit numbers are Armstrong numbers"
  (dotimes (n 9)
    (should (armstrong-p n)))
  )

(ert-deftest armstrong-nan ()
  "Nan is not an Armstrong number"
  (should (not (armstrong-p "foo"))))
...
(ert-deftest armstrong-number-548834 ()
  "Six digit number that should an Armstrong number"
  (should (armstrong-p 548834)))

;; 115132219018763992565095597973971522401
(ert-deftest armstrong-number-largest-base-10 ()
  "Largest base 10 Armstrong number"
