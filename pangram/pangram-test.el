...
(ert-deftest test-normalize-1 ()
  (should (equal "hquckbrownfoxjumpsovrhlazydog"
                 (normalize "7h3 qu1ck brown Fox jumps ov3r 7h3 lazy Dog"))))

(ert-deftest test-normalize-2 ()
  (should (equal "fivequackingzephyrsjoltmywaxbed"
                 (normalize "\"Five quacking Zephyrs jolt my wax bed.\""))))

(ert-deftest test-normalize-3 ()
